...
registerRouter().use(bodyParser.json());  // for parsing application/json
registerRouter().use(bodyParser.urlencoded({ extended: true }));  // for parsing application/urlencoded
